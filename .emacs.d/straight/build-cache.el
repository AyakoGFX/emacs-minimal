...
#s(hash-table test equal data ("straight" ("2025-03-30 02:22:38" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2025-03-30 02:22:38" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2025-03-30 02:22:38" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2025-03-30 02:22:38" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2025-03-30 02:22:38" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2025-03-30 02:22:38" nil (:type git :host github :repo "dimitri/el-get" :build nil :files (:defaults "methods" ("recipes" "recipes/el-get.rcp") "el-get-pkg.el") :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2025-03-30 02:22:38" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "lsp-bridge" ("2025-03-30 02:22:38" ("emacs" "markdown-mode") (:type git :host github :repo "manateelazycat/lsp-bridge" :files (:defaults "*.el" "*.py" "acm" "core" "langserver" "multiserver" "resources") :build (:not compile) :package "lsp-bridge" :local-repo "lsp-bridge")) "markdown-mode" ("2025-03-30 02:22:38" ("emacs") (:type git :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode"))))

#s(hash-table test equal data ("straight" ((straight-ert-print-hack straight-autoloads straight-x straight) (autoload 'straight-remove-unused-repos "straight" "Remove unused repositories from the repos and build directories.
...
(fn &optional ARG)" t) (register-definition-prefixes "markdown-mode" '("defun-markdown-" "gfm-" "markdown")) (provide 'markdown-mode-autoloads)) "lsp-bridge" ((lsp-bridge-rust lsp-bridge-dart lsp-bridge-epc lsp-bridge-ref lsp-bridge-autoloads lsp-bridge-call-hierarchy lsp-bridge-diagnostic lsp-bridge-semantic-tokens lsp-bridge-jdtls lsp-bridge-code-action lsp-bridge-lsp-installer lsp-bridge-inlay-hint lsp-bridge lsp-bridge-org-babel lsp-bridge-peek lsp-bridge-imenu) (autoload 'lsp-bridge-mode "lsp-bridge" "LSP Bridge mode.

This is a minor mode.  If called interactively, toggle the `Lsp-Bridge
