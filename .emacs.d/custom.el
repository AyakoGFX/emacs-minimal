...
(custom-set-variables
 ...
 '(package-selected-packages
   '(0x0 almost-mono-themes auctex beframe casual-suite company
         ...
         elfeed-autotag emmet-mode emms emms-setup emojify
         erc-hl-nicks erc-image evil ewal expand-region
         flycheck-ledger flymake-proselint flyspell-correct go-mode
         gruvbox-theme helpful jinx keycast ledger-mode lsp-latex
         lua-mode magit marginalia move-text multiple-cursors nix-mode
         nix-ts-mode notink-theme orderless proselint-flymake
         python-black pyvenv pywal sudo-edit tabspaces theme-magic
