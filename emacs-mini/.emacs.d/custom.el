(custom-set-variables
 ...
 '(package-selected-packages
   '(calfw-org jumplist jump-tree goto-last-change org-roam-ui websocket simple-httpd org-roam deft denote-menu denote corfu calfw nix-mode visual-fill-column magit vundo consult sudo-edit move-text vterm which-key vertico orderless marginalia)))
(custom-set-faces
