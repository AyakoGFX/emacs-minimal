(custom-set-variables
 ...
 '(package-selected-packages
   '(deft org-roam-ui websocket simple-httpd org-roam denote-menu corfu compat visual-fill-column magit vundo consult sudo-edit move-text vterm which-key vertico orderless marginalia)))
(custom-set-faces
